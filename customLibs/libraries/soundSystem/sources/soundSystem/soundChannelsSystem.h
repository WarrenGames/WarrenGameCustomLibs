...
/*
	SoundChannelSystem class's purpose is to configure the groups of sound playing 
		according to available channels. In order to achieve this, it ideally
		...
		File line example:
		8 12 16
		Here the group tag 8 will use the channels from 12 to 13 (so five sounds on group tag 8
